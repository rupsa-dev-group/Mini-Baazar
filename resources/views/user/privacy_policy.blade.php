        ...
        <div class="page-header breadcrumb-wrap">
            <div class="container">
                <div class="breadcrumb">
                    <a href="terms-conditions.html" rel="nofollow">Home</a>
                ...
                <div class="row">
                        ...
                        <div class="single-page pr-30 mb-lg-0 mb-sm-5">
                            ...
                            <div class="single-content">
                                <p> Please read these Terms of Service (“Terms”, “Terms of Service”) carefully before using
                                    the https://sharmadresses.in website (the “Service”) operated by Surfside Media (“us”,
                                    “we”, or “our”).</p>
                                ...
                                <p>Surfside Media has no control over, and assumes no responsibility for, the content,
                                    ...
                                    acknowledge and agree that Surfside Media shall not be responsible or liable, directly
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        <div class="widget-area">
                            <div class="sidebar-widget widget_alitheme_lastpost mb-20">
                                <div class="row">
                                    <div class="banner-img wow fadeIn mb-45 animated d-lg-block d-none">
                                        <img src="{{ asset('front_assets/imgs/banner/banner-11.jpg') }}" alt="">
                            ...
                            <!-- Widget categories removed as it's not being used -->
                            ...
                            <!-- Widget Tags removed as it's not being used -->
                        </div>
                    </div>
                </div>
            </div>
